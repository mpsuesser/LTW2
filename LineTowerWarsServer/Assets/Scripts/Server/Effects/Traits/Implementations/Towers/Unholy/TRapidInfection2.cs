...
public class TRapidInfection2 : Trait {
    public override TraitType Type => TraitType.RapidInfection2;
    ...
    public TRapidInfection2(ServerEntity entity) : base(entity) {
    ...
    public override float ManaRegenPerSecondDiff => TraitConstants.RapidInfection2ManaRegenPerSecond;
    public override int AdditionalAttackTargets => TraitConstants.RapidInfection2AdditionalTargets;
