...
public class TLightBurst1 : Trait {
    public override TraitType Type => TraitType.LightBurst1;

    public TLightBurst1(ServerEntity entity) : base(entity) {
    ...
    private void Pushback(ServerEntity attacker, List<ServerEntity> targets) {
        ...
        float gameDistanceToPushback =
            manaToConsume * TraitConstants.LightBurst1DistancePerManaConsumed;
    ...
    public override float ManaRegenPerSecondDiff =>
        TraitConstants.LightBurst1ManaRegenPerSecond;
}