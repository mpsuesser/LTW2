...
public class TIceLance1 : Trait {
    public override TraitType Type => TraitType.IceLance1;

    public TIceLance1(ServerEntity entity) : base(entity) {
