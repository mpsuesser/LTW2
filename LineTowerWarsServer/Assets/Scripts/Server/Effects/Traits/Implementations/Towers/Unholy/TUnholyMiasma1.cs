...
public class TUnholyMiasma1 : Trait {
    public override TraitType Type => TraitType.UnholyMiasma1;

    public TUnholyMiasma1(ServerEntity entity) : base(entity) { }

    public override float ManaRegenPerSecondDiff =>
        -TraitConstants.UnholyMiasma1ManaLossPerSecond;
    ...
    public override void CustomHandleAttackLandedImplementation(
        ...
        E.Status.GainMana(
            TraitConstants.UnholyMiasma1ManaPerAttack
        );
